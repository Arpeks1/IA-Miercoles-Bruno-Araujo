...
st.set_page_config(page_title="Mi pagina de prueba", page_icon="💀")
st.title("Mi primera prueba de streamlit")

nombre = st.text_input("Cual es tu nombre?")
if st.button("Saludar!"):
    st.write(f"Hola {nombre}! Bienvenido a una IA experimental")

#MODELOS = ["MODELO 1", "MODELO 2", "MODELO 3"]
MODELOS = ['llama-3.1-8b-instant', 'llama-3.3-70b-versatile'] #'deepseek-r1-distill-llama-70b' (tercer modelo, fallo)
...
#python -m streamlit run clase6.py
